...
import PhotographyOptions from './PhotographyOptions'; 

export default function AddServices() {
  const [formData, setFormData] = useState({
    category: 'Cake', // القيمة الافتراضية للبدء
    title: '',
    description: '',
    basePrice: '',
          ...
          <div style={{ flex: '1', minWidth: '300px', display: 'flex', flexDirection: 'column', gap: '20px' }}>
            <div>
              ...
              <select 
                ...
                style={{ width: '100%', padding: '12px', borderRadius: '8px', border: '1px solid #E8D0CB', backgroundColor: '#FFF', color: '#4A1525', outline: 'none' }}
              >
